    ...
    with tf.Session(graph=detection_graph) as sess:
        while True:
                ...
                for b in range(0, np.size(box,0)-1):
                    if scores[0][b] > 0.70:
                        ...
                        for index in range(0,len(board_list)):                             
                            if int(x_avr) in range(board_list[index][0]-20, board_list[index][0]+20) and int(y_avr) in range(board_list[index][1]-20, board_list[index][1]+20):
            ...
            for i in range(0,len(piece_list)):
                if i1 == 32:
                    if new_piece_list[48] != piece_list[48]:
                        i2 = 48
                        break
                    elif new_piece_list[16] != piece_list[16]:
                        i2 = 16
                        break
